    ...
    const allRoles = ['Admin', 'Ketua Jemaat', 'Pendeta', 'Bendahara', 'Diakon', 'Viewer', 'Daerah', 'Publik'];
    const allMenus = [
    ...
    function getDefaultRolePerms(role) {
      const defs = {
        ...
        Daerah: { menus: { dashboard: { view: true, edit: false, del: false }, pemasukan: { view: false, edit: false, del: false }, pengeluaran: { view: false, edit: false, del: false }, pindahbuku: { view: false, edit: false, del: false }, laporan: { view: true, edit: false, del: false }, riwayat: { view: true, edit: false, del: false, approve: false }, masterData: { view: false, edit: false, del: false }, users: { view: false, edit: false, del: false }, akun: { view: true, edit: true, del: true }, settings: { view: false, edit: false, del: false }, logs: { view: false, edit: false, del: false }, inventaris: { view: true, edit: false, del: false } }, isAnonymous: false },
  ...
  `;
    ...
    `;
      ...
      if (recent.length === 0) {
        ...
        let desktopHtml = recent.map(x => {
          ...
          return `<tr><td class="fit-col">${fmtDate(x.date)}</td><td class="fit-col"><span class="badge ${x.badge}">${x.label}</span></td><td style="max-width:250px; white-space:normal; word-wrap:break-word;"><span class="badge ${getCatBadge(x.income_type || x.department, x.kind !== 'income')}">${x.income_type || x.department}</span><br><div style="font-size:12px; color:var(--text-muted, var(--text4)); margin-top:4px;">${shouldHide ? '***' : (x.note || '-')}</div></td><td class="fit-col"><div style="display:flex; align-items:center; gap:6px;"><span class="badge badge-gray" title="${x.receipt_no}" style="width:105px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; display:inline-block; vertical-align:middle; text-align:center;">${shortReceipt}</span><span style="display:inline-flex;align-items:center;vertical-align:middle;">${photoBtn}</span></div></td><td class="fit-col ${x.style}" style="text-align:right">${x.sign}${fmt(x.amount)}</td></tr>`;
        }).join('');
    ...
    function generateComplexReportHtml(isExcel = false) {
                ...
                <table style="width: 100%; border: none; margin: 0; color: #000; font-family: sans-serif;">
                  <tr>
                    ...
                    <td style="border: none; text-align: center; vertical-align: middle; padding: 0;">
                      ...
                      <p style="margin:5px 0 0 0; font-size: 10pt;">Nama Jemaat: <strong>${systemConfig.app_name || 'PISGAH - BISDAC'}</strong></p>
                    ...
                    <td style="width: 100px; border: none; text-align: right; vertical-align: middle; padding: 0;">
                      <img src="${systemConfig.logo_sidebar || systemConfig.logo_login || './icons/PisgahColor.png'}" style="width: 80px; height: auto;" alt="Logo Kanan" />
                    </td>
                  </tr>
                </table>
              </th>
          ...
          <tr>
            ...
            <td style="vertical-align: top; width: 50%;">
              <table style="width: 100%; max-width: 350px; font-size: ${bottomFontSize}; float:right;" cellpadding="0" cellspacing="0">
                <tr><td style="padding-bottom: 4px;">Perpuluhan</td><td style="text-align: right; padding-bottom: 4px;">${isExcel ? sumPerpuluhan : fmt(sumPerpuluhan)}</td></tr>
                <tr><td style="padding-bottom: 4px;">Terpadu (50%)</td><td style="text-align: right; padding-bottom: 4px;">${isExcel ? sumTerpaduDaerah : fmt(sumTerpaduDaerah)}</td></tr>
                <tr><td style="padding-bottom: 4px;">Khusus Daerah</td><td style="text-align: right; padding-bottom: 4px;">${isExcel ? sumKhususDaerah : fmt(sumKhususDaerah)}</td></tr>
                <tr><td style="font-weight:bold; border-top: 1px solid #000; padding-top: 4px;">Total Transfer Daerah</td><td style="font-weight:bold; text-align: right; border-top: 1px solid #000; padding-top: 4px;">${isExcel ? sumPemasukanDaerah : fmt(sumPemasukanDaerah)}</td></tr>
              </table>
            </td>
          </tr>
        </table>
      ...
      html += `
        <table style="${tableStyle} margin-top: 30px; page-break-before: always;">
          <thead>
            <tr>
              <th colspan="7" style="border: none; background: white; padding-bottom: 20px;">
                <table style="width: 100%; border: none; margin: 0; color: #000; font-family: sans-serif;">
                  <tr>
                    <td style="width: 100px; border: none; text-align: left; vertical-align: middle; padding: 0;">
                      <img src="data:image/png;base64," style="width: 80px; height: auto;" alt="Logo Kiri" />
                    ...
                    <td style="border: none; text-align: center; vertical-align: middle; padding: 0;">
                      <h2 style="margin:0; font-size: 14pt; font-weight: bold;">DAERAH SUMATERA KAWASAN TENGAH</h2>
                      <h3 style="margin:5px 0 0 0; font-size: 12pt;">LAMPIRAN: RINCIAN PENGELUARAN JEMAAT & DAERAH</h3>
                      <p style="margin:5px 0 0 0; font-size: 10pt;">Nama Jemaat: <strong>${systemConfig.app_name || 'PISGAH - BISDAC'}</strong></p>
                      <p style="margin:5px 0 0 0; font-size: 10pt;">Bulan/Tahun: <strong>${periodStr}</strong></p>
                    </td>
                    <td style="width: 100px; border: none; text-align: right; vertical-align: middle; padding: 0;">
    ...
    function renderReportView() {
      ...
      document.getElementById('reportContent').innerHTML = generateComplexReportHtml(false);
    ...
    function generateReceiptHTML(type, mainTx, customItems = null) {
      ...
      return `
        <div class="receipt-page" style="position: relative; font-family: 'Inter', 'Helvetica Neue', sans-serif; padding: 15px 15px 10px 15px; max-width: 100%; min-height: 95mm; height: max-content; margin: 0; color: #000; background: white; box-sizing: border-box; page-break-inside: avoid; border-bottom: 1px dashed #ccc;">
          ${watermarkHtml}
          <div style="position: relative; z-index: 1; color: #000;">
    ...
    window.batchUploadOldReceipts = async function() {
      ...
      batchOverlay.innerHTML = `<h2>Memproses ${toUpdate.length} transaksi...</h2><p>Jangan tutup halaman ini.</p>`;
      ...
      for(let i=0; i<toUpdate.length; i++) {
        let r = toUpdate[i];
        let type = r.income_type ? 'income' : 'expense';
        
        batchOverlay.innerHTML = `<h2>Memproses ${i+1} dari ${toUpdate.length}</h2><p>ID: ${r.receipt_no}</p><p style="margin-top: 20px; font-size: 14px; color: #aaa;">Sistem juga sedang menyimpan ke database...</p>`;
        ...
        try {
          ...
          if (type === 'income') {
            payload = {
              ...
              original: r, income_type: r.income_type, unit_name: r.unit_name, nama_pemberi: r.nama_pemberi
            };
          } else {
            payload = {
              type: 'expense', transaction_id: r.transaction_id || r.id, date: r.date, receipt_no: r.receipt_no, amount: r.amount, note: r.note,
              receipt_photo_base64: genBase64, receipt_photo_base64_2: '', receipt_photo_base64_3: '',
              original: r, department: r.department, source_balance: r.source_balance, nama_penerima: r.nama_penerima
            };
          }
          
          // Use editRecord to update
          await apiPostWithFallback('editRecord', payload);
          success++;
          console.log(`Success ${success}/${toUpdate.length}`);
        } catch(e) {
          console.error("Failed", r.receipt_no, e);
          failed++;
        }
        
        // Wait 1s between requests to avoid hitting Apps Script rate limits
    ...
    function renderMasterUnits() {
      document.getElementById('unitList').innerHTML = (masterData?.units || []).map((x, i) => `<div style="display:flex; justify-content:space-between; align-items:center; padding:12px 0; border-bottom:1px solid var(--glass-border)"><div style="display: flex; gap: 10px;"><div>${i + 1}.</div><div><strong>${x.name}</strong>${x.jumlah_anggota ? `<br><small style="color:var(--text3)">${x.jumlah_anggota} Jiwa</small>` : ''}</div></div><div style="display:flex; gap:6px;"><button class="btn-icon-only" onclick="editUnit('${x.name.replace(/'/g, "\\'")}', '${(x.note || '').replace(/'/g, "\\'")}', ${x.jumlah_anggota || 0})">${safeIcon('edit')}</button><button class="btn-icon-only" style="color:var(--red-pop);" onclick="deleteUnit('${x.name.replace(/'/g, "\\'")}')">${safeIcon('trash')}</button></div></div>`).join('') || '<div class="empty-state">No Data</div>';
      ...
      let html = `
        <table style="width: 100%; border: none; margin-bottom: 20px; color: #000; font-family: sans-serif;">
          <tr>
            ...
            <td style="border: none; text-align: center; vertical-align: middle; padding: 0;">
              <h2 style="margin:0; font-size: 14pt; font-weight: bold;">GMAHK Jemaat ${systemConfig.app_name || 'PISGAH BISDAC'}</h2>
